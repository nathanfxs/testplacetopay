    ...
    public function payment($id)
    {
        ...
        else
        {
            ...
            $request = [
                ...
                'returnUrl' => url("/orders/payment/check-status/{$order->id}"), //"http://localhost/testplacetopay/public/orders/payment/check-status/{$order->id}",
                'cancelUrl' => url("/orders/payment/check-status/{$order->id}"),
                'skipResult' => false,
                'noBuyerFill' => false,
